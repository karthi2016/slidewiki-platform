...
export default function loadSlide(context, payload, done) {
    ...
    if (!(AllowedPattern.SLIDE_ID.test(payload.params.sid))) {
    ...
    payloadCustom.params.stype = 'slide';
    ...
    async.parallel([
        ...
        (callback) => {
            context.executeAction(loadContentUsage, payloadCustom, callback);
        },
        // (callback) => {
