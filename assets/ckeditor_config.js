...
CKEDITOR.editorConfig = function( config ) {
    ...
    //TODO - CKEDITOR expects script to be returned for inserting image in CKeditor content
    //       is problem with Same-origin_policy
    //       https://developer.mozilla.org/en-US/docs/Web/Security/Same-origin_policy
    //TODO - Perhaps instead create platform page, or importservice URL,
    //       or media-service-url (copy import docker) for uploading?!
    //       reuse superagent work??
    //TODO - return JSON for drag and drop -> http://docs.ckeditor.com/#!/api/CKEDITOR.editor-event-fileUploadResponse
